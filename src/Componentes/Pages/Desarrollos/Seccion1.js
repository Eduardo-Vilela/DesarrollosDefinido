       ...
       <SubBoxLotes>
         ...
         <AjusteFotos >
           ...
           <LinkFlip to='/Lasvictorias'>
            ...
            <LinkFlip to='/Eljuncal' style={{borderRight: 'solid 1px #E5E5E5'}}>
              <Lote  data-aos="flip-up " data-aos-duration="1000" >
                <div className='front'>
           ...
           <LinkFlip to='/Latitud34'>
            ...
            <LinkFlip to='/Lacampina' style={{borderRight: 'solid 1px #E5E5E5'}}>
              <Lote data-aos="flip-up " data-aos-duration="1000" >
                <div className='front'>
                   <ContenedorFotoLotes  alt='fotoDesarrollo' src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715459/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/Portadas-02_knbvxl_nmvbcd.webp'/>
                </div>
                <div className='back'>
                 <TituloFlips>La Campiña</TituloFlips>
                 <SubtituloFlips>calle 229 entre 38 y 42</SubtituloFlips>
                 <img alt='aaaa' style={{width: '100%', borderRadius:'10px'}} src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715436/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/lacampi1_qxte9w_lopuuo.webp'/>
                </div>
              </Lote>
            </LinkFlip>  
           </AjusteFotos>
           <AjusteFotos>
            <LinkFlip to='/Lasorianas'>
              <Lote data-aos="flip-up " data-aos-duration="1000" >
                <div className='front'>
                  <ContenedorFotoLotes alt='fotoDesarrollo' src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715458/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/Portadas-03_ddaifm_jgeowb.webp'/>
               </div> 
                <div className='back'>
                 <TituloFlips>Las Orianas</TituloFlips>
                 <SubtituloFlips>Calle 515 entre 168 y 170</SubtituloFlips>
                 <img alt='aaaa' style={{width: '100%', borderRadius:'10px'}} src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715428/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/Intro-Card-Las-Orianas-Dorso_axmuf8_wtrnsj.webp'/>
                </div>
              </Lote>
            </LinkFlip>
            <LinkFlip to='/Laescondida' style={{borderRight: 'solid 1px #E5E5E5'}}>
              <Lote data-aos="flip-up " data-aos-duration="1000"  >
                <div className='front'>
                  <ContenedorFotoLotes className='front' alt='fotoDesarrollo' src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715487/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/dsadasdasd-1024x877_f59iqi_kg9flb.webp'/>
                </div>  
                <div className='back'>
                 <TituloFlips>La Escondida</TituloFlips>
                 <SubtituloFlips>Calle 84 entre 161 y 167</SubtituloFlips>
                 <img alt='aaaa' style={{width: '100%', borderRadius:'10px'}} src='https://res.cloudinary.com/desarrollogrupodelsud/image/upload/v1657715464/DESARROLLOSGRUPODELSUD_2022-07-13_08_54/Render05-1024x576_xfqrrc_hzwgp3.webp'/>
                </div>
              </Lote>
            </LinkFlip>  
           </AjusteFotos>
