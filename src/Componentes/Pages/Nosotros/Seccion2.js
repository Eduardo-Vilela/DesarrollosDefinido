...
function Seccion2() {
  return (
    ...
    <BoxPadre1>
        <SubBoxPadre2>
            <Contenedor1>
            <Video1 loop muted autoPlay data-aos="fade-up" data-aos-duration="3000">
                <source
              ...
              <br/>
              <Video2  loop muted autoPlay data-aos="fade-right" data-aos-duration="3000">
                <source
            ...
            <Contenedor2>
                <Video3  loop muted autoPlay data-aos="fade-left" data-aos-duration="3000">
                    <source
