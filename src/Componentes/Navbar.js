...
/*stylessssss */
import '../Componentes/Estilos/Navbar.css'
  ...
  return (
      <>
           <Navbar className={navbar ? "navbar navBar active navbar777" : "navbar navbar77"}  fixed="top" expand="lg">
            <Container id="arriba2">
              <Navbar.Brand href="#home"> <Link to='/'>
                {
                  window.scrollY >= 200 ? 
                    <img style={{width:'80%'}} src='https://res.cloudinary.com/grupo-delsud/image/upload/v1646942039/DESARROLLOSGRUPODELSUD/logoNav_h8jfaz.svg' alt="lala"/ > 
                  :
                    <img style={{width:'80%'}} src='https://res.cloudinary.com/grupo-delsud/image/upload/v1648360095/DESARROLLOSGRUPODELSUD/Group_s8dqa5.svg ' alt="lala2"/ >
                }
              </Link> 
               </Navbar.Brand>
